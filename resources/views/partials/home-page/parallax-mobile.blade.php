...
<div id="section1" class="container">
  ...
  <div class="row">
    ...
    <div class="col s12 m12 l8 p-text"><h3 class="center">Tko smo mi?</h3>
...
<div class="without-p-img"><img src="{{ URL::asset('storage/settings/home-page/home-image-1-mobile.jpg') }}"></div>
...
<div id="section2" class="container">
    ...
    <div class="col s12 m12 l4 center p-font-image"><i class="fa fa-laptop" aria-hidden="true"></i></div>
      ...
      <div class="col s12 m12 l8 p-text"><h3 class="center">Čime se bavimo?</h3>
...
<div class="without-p-img"><img src="{{ URL::asset('storage/settings/home-page/home-image-2-mobile.jpg') }}"></div>
...
<div id="section3" class="container">
    ...
    <div class="col s12 m12 l4 center p-font-image"><i class="fa fa-handshake-o" aria-hidden="true"></i></div>
      ...
      <div class="col s12 m12 l8 p-text"><h3 class="center">Kako se uključiti?</h3>
  ...
  <div class="without-p-img"><img src="{{ URL::asset('storage/settings/home-page/home-image-3-mobile.jpg') }}"></div>



<div id="section4" class="container">

  <div class="row p-partners">

      <div class="col s12 m12 l12 center"><h3>Partneri</h3></div>

      <div class="col s12 m12 l12 center divider"></div>

      <div class="col s12 m4 l4 center"><img class="partners-logo" src="{{ URL::asset('storage/settings/home-page/krizevci-logo.png') }}"></div>

      <div class="col s12 m4 l4 center"><img class="partners-logo" src="{{ URL::asset('storage/settings/home-page/point-logo.png') }}"></div>

      <div class="col s12 m4 l4 center"><img class="partners-logo" src="{{ URL::asset('storage/settings/home-page/espr-logo.png') }}"></div>
