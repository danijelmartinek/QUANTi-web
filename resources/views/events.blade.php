        ...
        <span class="col s12 m6 l4">
          ...
          <div class="card horizontal">
	        ...
	        <div class="card-image" style="margin: 0 auto;">
                  <img data-caption="Poster Križevačkih Tehnoloških Večeri 2017." src="{{ URL::asset('storage/events/krizevacke-tehnoloske-veceri.jpg') }}">
                </div>
		<br>
                <span class="card-title">Križevačke Tehnološke Večeri</span>
                <p class="left-align">"Križevačke Tehnološke Večeri" je skup događaja na kojima nastupaju ljudi iz raznih područja tehnologije koji predstavljaju tehnologije kojima se bave te tako pokušavaju privući što više interesa za tu tehnologiju ili područje.</p>
              </div>
            </div>
          </div>
          </span>
